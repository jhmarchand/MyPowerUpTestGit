...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		spStick = new Joystick(1);
		
		topLeft = new WPI_TalonSRX(2);
		topRight = new WPI_TalonSRX(1);
		bottomLeft = new WPI_TalonSRX(4);
		bottomRight = new WPI_TalonSRX(3);
		
		controlR = new SpeedControllerGroup(topRight, bottomRight);
		controlL = new SpeedControllerGroup(topLeft, bottomLeft);
		
		roboDrive = new DifferentialDrive(controlL, controlR);
	...
	public void teleopPeriodic() {
		roboDrive.arcadeDrive(stick.getX(),stick.getY());
